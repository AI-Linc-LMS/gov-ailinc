...
import { installDemoTransport } from "../demo";
...
// DEMO REPO ONLY: swap the network for the in-browser fake backend. This is the
// single seam that makes this fork a self-contained prototype — every service
// module below keeps its interceptors, error handling and loading states, but is
// answered from `lib/demo/` instead of a server. See `lib/demo/index.ts`.
installDemoTransport(apiClient);
