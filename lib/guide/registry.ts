  ...
  features: [
    {
      ...
      text: "Take courses grouped into sections and categories. Each one adjusts to your level as you work: articles, quizzes and assignments, with feedback as you go.",
    },
    {
    ...
    },
    {
      ...
      text: "Sit a practice interview that follows up on your answers, then read how it was scored against the rubric.",
    },
    {
      icon: "mdi:video",
      color: "#0e7a3c",
    ...
    },
    {
      ...
      color: "#b7791f",
      title: "Read job notifications",
      text: "Recruitment notifications and local openings, filtered to what you are eligible for, with every application tracked in one place.",
    },
    {
      icon: "mdi:trophy-outline",
      color: "#c9903a",
...
export const PAGE_GUIDES: Record<string, PageGuideContent> = {
    ...
    tourSteps: [
      {
        ...
        title: "Your courses",
        narration: "These are the courses you are enrolled in, laid out the way the catalogue is: sections, and categories inside them. Each course adapts to your level as you work. Browse courses, in the header, opens the full catalogue when you want something you have not joined yet.",
        placement: "bottom",
        icon: "mdi:book-education-outline",
        color: "#85aad6",
      },
      {
        ...
        narration: "These tabs narrow the page to one difficulty. Beginner assumes no exam background and explains the vocabulary; Advanced is written for a repeat attempt. Each tab carries a live count so you know how many of your courses sit at that level.",
        placement: "bottom",
        icon: "mdi:tune-variant",
        color: "#1b4f8a",
      },
      {
        // No anchor: this step explains the shape of the page rather than
        // pointing at one control, and the chip row it describes sits between
        // the two steps on either side of it.
        title: "How the catalogue is arranged",
        narration: "Courses sit in two sections. Government Job Related Courses covers state, central, railway, police, public undertaking and banking recruitment. Skill Development and Entrepreneurship covers the vocational trades and the enterprise track run through the district skill centres. Each section holds two categories, and the chip row under the level tabs narrows the page to a single one of them.",
      ...
      },
      {
        ...
        narration: "Search matches a course title, its description, who it is written for, and its section and category names, so typing banking finds the whole category. Sort by recently updated, title, or amount of content, and switch between cards and a compact list.",
        placement: "bottom",
        icon: "mdi:magnify",
        color: "#b7791f",
      },
      {
        ...
        narration: "Each section carries a heading, a one line description and a count, with its categories under it and your course cards inside those. Open a card to go straight in; hovering quietly prefetches it, so it opens without a wait.",
        placement: "top",
        icon: "mdi:view-grid-outline",
        color: "#0f6b7a",
      },
      {
        title: "That is the page",
        narration: "Pick the course you are preparing for and carry on from where you stopped. The content adjusts to your level as you go.",
        icon: "mdi:rocket-launch-outline",
        color: "#0e7a3c",
      },
    ],
    headerTitle: "Your courses, grouped the way the catalogue is",
    headerSubtitle: "Sections, the categories inside them, and two filter rows to narrow the page down to what you want.",
    features: [
      {
        icon: "mdi:shape-outline",
        color: "#1b4f8a",
        title: "Two sections",
        text: "Government Job Related Courses, and Skill Development and Entrepreneurship. A section appears here only when you are enrolled in something inside it.",
      },
      {
        icon: "mdi:bank-outline",
        color: "#1b4f8a",
        title: "Four categories",
        text: "State, Central and PSU jobs and Banking sit under the first section; Rural Employment Generation, which is the vocational trades, and Rural Entrepreneurship and Development sit under the second. Every heading carries a one line description and a count.",
      },
      {
        icon: "mdi:filter-variant",
        color: "#85aad6",
        title: "Filter by category",
        text: "The chip row above the search box narrows the page to one category. It filters in place rather than scrolling, so the search box stays where you left it.",
      },
      {
        icon: "mdi:tune-variant",
        color: "#0e7a3c",
        title: "Filter by level",
        text: "The level tabs narrow the page to a single difficulty, each showing a live count of the courses that match.",
      },
      {
        icon: "mdi:magnify",
        color: "#0f6b7a",
        title: "Search the page",
        text: "Type a course title, a word from its description, the audience it is written for, or a section or category name.",
      },
      {
        icon: "mdi:sort",
        color: "#b7791f",
        title: "Sort and switch views",
        text: "Reorder by most recently updated, title A-Z, or the courses carrying the most content, and toggle between roomy cards and a compact list.",
      },
      {
        icon: "mdi:card-account-details-outline",
        color: "#c9903a",
        title: "What a card tells you",
        text: "Each card carries its category chip and counts of modules, submodules, articles and quizzes, so it still reads correctly away from its heading.",
      },
    ],
    tip: "Section and category names are searchable, so typing solar or banking into the search box gets you to the right group without touching the chips.",
  },
  ...
  "/admin/jobs-v2": {
    tourSteps: [
      {
        targetId: "page-header",
        title: "Job Notifications overview",
        narration: "This is where you publish recruitment notifications and local openings for your candidates. Let us walk through the key controls.",
        placement: "bottom",
    ...
    headerTitle: "What you can do on Job Notifications",
    headerSubtitle: "Publish notifications and openings, scope them to the candidates they suit, and track who applies.",
    features: [
      {
        icon: "mdi:briefcase-plus-outline",
        color: "#1b4f8a",
        title: "Publish a notification",
        text: "Open the builder to add a notification or an opening, with the recruiting body, the courses it suits, and a last date to apply.",
      },
      {
        icon: "mdi:filter-variant",
        color: "#1b4f8a",
    ...
    tourSteps: [
      {
        targetId: "page-header",
        title: "Job Notifications overview",
        narration: "Recruitment notifications and local openings, matched to what you are preparing for. Filter them down to what you are eligible for, and track every application you send from the same page.",
        placement: "bottom",
        icon: "mdi:briefcase-search",
        color: "#c9903a",
      },
      {
        ...
        narration: "Search by post, recruiting body or keyword, and narrow by location and experience. Press search and the list updates straight away.",
        placement: "bottom",
        icon: "mdi:magnify",
        color: "#1b4f8a",
      },
      {
        ...
        narration: "Use this sidebar to narrow the list by type of post, employment type and skills. Clear everything at any point to start again.",
        placement: "right",
        icon: "mdi:filter-variant",
        color: "#1b4f8a",
      },
      {
        ...
        narration: "One tab lists the notifications open to you; the other keeps an eye on the ones you have already applied to.",
        placement: "bottom",
        icon: "mdi:tab",
        color: "#85aad6",
      },
      {
        ...
        title: "What you match",
        narration: "The notifications you match appear here. Switch between card and list views, choose how many to show per page, and page through the rest.",
        placement: "top",
        icon: "mdi:view-list",
        color: "#0e7a3c",
      },
      {
        ...
        narration: "That is the notification board. Search, narrow it down, apply, then come back to the applications tab to follow what happens next.",
        icon: "mdi:check-circle",
        color: "#0f6b7a",
      },
    ],
    headerTitle: "Find your next post in Job Notifications",
    headerSubtitle: "Read recruitment notifications and local openings, narrow them to what fits you, and track every application from one page.",
    features: [
      {
        icon: "mdi:briefcase-search",
        color: "#1b4f8a",
        title: "Browse what you match",
        text: "Each card carries the recruiting body, the location, the experience and passing year expected, the skills asked for, and how recently it was posted.",
      },
      {
        icon: "mdi:magnify",
        color: "#1b4f8a",
        title: "Search precisely",
        text: "Search by post, recruiting body or skill, and narrow by location and years of experience, all from the search bar at the top.",
      },
      {
        icon: "mdi:filter-variant",
        color: "#85aad6",
        title: "Refine with filters",
        text: "Narrow the list by type of post, employment type, location and particular skills, then clear it all in one press.",
      },
      {
        icon: "mdi:heart-outline",
        color: "#0f6b7a",
        title: "Save your favourites",
        text: "Press the heart on any card to save that notification and come back to it later.",
      },
      {
        icon: "mdi:file-document-outline",
        color: "#b7791f",
        title: "Open full details",
        text: "Open any notification to read it in full, check what is asked for, and apply.",
      },
      {
        icon: "mdi:progress-check",
        color: "#0e7a3c",
        title: "Track your applications",
        text: "Switch to the applications tab to watch each one move from applied through shortlisted and the interview stage to selected.",
      },
      {
        icon: "mdi:trophy-outline",
        color: "#c9903a",
        title: "Where a selection shows",
        text: "Any post you are selected for is spotlighted in a banner at the top of your applications.",
      },
    ],
    tip: "In the applications tab, use the status chips and the sort menu to pick out the applications that are actually moving. For a denser list, use the card and list toggle above the results.",
  },
  "/live-sessions": {
    tourSteps: [
      {
  ...
  "/mock-interview": {
    ...
    headerTitle: "What you can do with Interview Practice",
    headerSubtitle: "Sit a practice interview, then read how each answer was scored against the rubric.",
    features: [
      {
        icon: "mdi:lightning-bolt",
        color: "#0e7a3c",
