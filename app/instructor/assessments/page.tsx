    ...
    <PageShell>
      ...
      {totalPending > 0 && (
        <Box sx={{ mb: 2, p: 1.5, borderRadius: 2, display: "inline-flex", alignItems: "center", gap: 1,
          bgcolor: "color-mix(in srgb, #b7791f 12%, transparent)", color: "#8a5a12", fontWeight: 700 }}>
            ...
            <Box sx={{ p: 2.25, borderRadius: 3, bgcolor: "var(--card-bg)", border: "1px solid var(--border-default)" }}>
              <Stack direction="row" alignItems="flex-start" spacing={1.25}>
                <Box sx={{ width: 40, height: 40, borderRadius: 2.5, flexShrink: 0, display: "grid", placeItems: "center",
                  color: "#fff", background: "linear-gradient(135deg,#b7791f,#0f6b7a)" }}>
              ...
              <Stack direction="row" spacing={1} sx={{ mt: 1.5 }}>
                ...
                <Chip size="small"
                  ...
                  sx={{ fontWeight: 700, color: a.pending_grading ? "#8a5a12" : "#0B6232",
                    bgcolor: `color-mix(in srgb, ${a.pending_grading ? "#b7791f" : "#0e7a3c"} 14%, transparent)` }} />
              </Stack>
            </Box>
          </Reveal>
        ))}
