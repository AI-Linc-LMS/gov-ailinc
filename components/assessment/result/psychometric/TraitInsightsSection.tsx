        ...
        {insights.map((insight) => {
          ...
          return (
            <div
              ...
              className="border border-slate-200 rounded-xl overflow-hidden transition-all hover:border-[#85aad6] hover:shadow-md"
            >
              <button
                onClick={() => toggleExpanded(insight.trait_id)}
                className="w-full px-5 py-4 flex justify-between items-center hover:bg-gradient-to-r hover:from-[#eef3fa] hover:to-[#eef3fa] transition-all duration-200"
              >
