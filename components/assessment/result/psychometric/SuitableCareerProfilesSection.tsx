  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 border-2 border-slate-200">
      ...
      <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
        <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#1b4f8a] to-[#164274] flex items-center justify-center shadow-lg flex-shrink-0">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
        <div className="bg-gradient-to-br from-[#eef3fa] to-[#eef3fa] rounded-xl p-3 sm:p-4 border-2 border-[#b6cde8]">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs sm:text-sm font-semibold text-[#12365f]">Total Profiles</span>
            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#164274]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </div>
          <p className="text-2xl sm:text-3xl font-bold text-[#0a1e37]">{sortedProfiles.length}</p>
          <p className="text-xs text-[#164274] mt-1">Job Roles</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-[#e6f1f2] rounded-xl p-3 sm:p-4 border-2 border-blue-200">
          <div className="flex items-center justify-between mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
        ...
        <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl p-4 sm:p-6 border-2 border-slate-200">
          <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
            <svg className="w-5 h-5 text-[#164274]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
      ...
      <div className="space-y-4 sm:space-y-6">
        {sortedProfiles.map((profile, index) => (
          <div
            key={index}
            className="group bg-gradient-to-br from-slate-50 to-white rounded-2xl p-4 sm:p-6 border-2 border-slate-200 hover:border-[#85aad6] hover:shadow-xl transition-all duration-300"
          >
            {/* Profile Header */}
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                  {profile.fitment_reasons.map((reason, reasonIndex) => (
                    <div
                      key={reasonIndex}
                      className="flex items-start gap-2 p-3 bg-[#eef3fa] rounded-lg border border-[#d9e6f4]"
                    >
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#164274] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <ul className="space-y-2">
                  {profile.responsibilities.map((responsibility, respIndex) => (
                    <li key={respIndex} className="flex items-start gap-2 text-xs sm:text-sm text-slate-600">
                      <span className="text-[#164274] mt-1.5 flex-shrink-0">•</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
              {/* Emotional Alignment */}
              <div className="bg-gradient-to-br from-blue-50 to-[#eef3fa] rounded-xl p-3 sm:p-4 border border-blue-100">
              ...
              {/* Social Alignment */}
              <div className="bg-gradient-to-br from-[#eef3fa] to-[#e6f1f2] rounded-xl p-3 sm:p-4 border border-[#d9e6f4]">
                <div className="flex items-center gap-2 mb-2">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#164274]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  <h5 className="text-xs sm:text-sm font-semibold text-[#0a1e37]">Social Fit</h5>
                </div>
                <p className="text-xs sm:text-sm text-[#12365f] leading-relaxed">{profile.social_alignment}</p>
              </div>
                    ...
                    <div key={skillIndex} className="bg-white rounded-lg p-3 sm:p-4 border border-slate-200">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs sm:text-sm text-[#164274] font-semibold">Target: {skill.required_level}/100</span>
                        </div>
                      </div>
            ...
            {profile.timeline && (
              <div className="mb-4 sm:mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                  <div className="bg-gradient-to-br from-blue-50 to-[#eef3fa] rounded-xl p-3 sm:p-4 border border-blue-200">
                  ...
                  <div className="bg-gradient-to-br from-[#eef3fa] to-[#e6f1f2] rounded-xl p-3 sm:p-4 border border-[#b6cde8]">
                    <h5 className="text-xs sm:text-sm font-bold text-[#0a1e37] mb-2">Mid Term (1-3 years)</h5>
                    <p className="text-xs sm:text-sm text-[#12365f] leading-relaxed">{profile.timeline.mid_term}</p>
                  </div>
