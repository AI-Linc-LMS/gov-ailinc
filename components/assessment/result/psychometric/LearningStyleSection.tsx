  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-slate-200 hover:shadow-xl transition-shadow duration-300">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#1b4f8a] to-[#0f6b7a] flex items-center justify-center shadow-lg">
      ...
      <div className="space-y-6 mb-6">
        <div className="p-5 rounded-xl bg-gradient-to-br from-[#eef3fa] to-[#e6f1f2] border border-[#b6cde8]">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 hover:border-[#85aad6] hover:bg-[#eef3fa]/50 transition-all duration-200">
      ...
      <div className="pt-6 border-t border-slate-200">
        ...
        <div className="flex flex-wrap gap-3">
          {learningStyle.recommended_content_formats.map((format, index) => (
            <button
              key={index}
              className="group px-5 py-3 bg-gradient-to-br from-blue-50 to-[#eef3fa] hover:from-blue-100 hover:to-[#d9e6f4] text-blue-700 rounded-xl text-sm font-semibold transition-all duration-200 border border-blue-200 hover:border-blue-400 hover:shadow-md flex items-center gap-2"
            >
