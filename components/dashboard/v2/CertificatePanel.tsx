  ...
  return (
    <PanelCard>
      <Box sx={{ textAlign: "center", py: 0.5 }}>
        <Box sx={{ width: 56, height: 56, mx: "auto", mb: 1, borderRadius: 3, display: "grid", placeItems: "center", color: "white", background: "linear-gradient(135deg, #14406f, #1b4f8a)", boxShadow: "0 12px 26px -12px rgba(20, 64, 111,0.6)" }}>
          <Icon icon="mdi:certificate" width={28} />
        </Box>
        <Typography sx={{ fontSize: "0.6rem", fontWeight: 800, letterSpacing: 0.6, color: "#14406f", textTransform: "uppercase" }}>
      ...
      <Box sx={{ mt: 1.5 }}>
        <LinearProgress variant="determinate" value={Math.min(100, pct)} sx={{ height: 8, borderRadius: 4, bgcolor: "#eef2f7", "& .MuiLinearProgress-bar": { borderRadius: 4, background: "linear-gradient(90deg, #14406f, #0f6b7a)" } }} />
      ...
      <ButtonBase
        ...
        sx={{ mt: 1.5, width: "100%", py: 1.1, borderRadius: 2.5, fontWeight: 800, fontSize: "0.88rem", color: "white", gap: 0.5, background: "linear-gradient(135deg, #14406f, #0f6b7a)" }}
      >
